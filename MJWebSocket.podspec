...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/yangyu2010@aliyun.com/MJWebSocket'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'yangyu2010@aliyun.com' => 'yangyu2010@aliyun.com' }
  s.source           = { :git => 'https://github.com/yangyu2010@aliyun.com/MJWebSocket.git', :tag => s.version.to_s }
  ...
  # s.resource_bundles = {
  #   'MJWebSocket' => ['MJWebSocket/Assets/*.png']
  # }
